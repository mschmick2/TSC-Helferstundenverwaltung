<?php
/**
 * Modul 6 I7b4 Phase 2 — Sortierbare Task-Liste, Admin-Container.
 *
 * Read-only Chronologie der Leaves eines Events. Rendert das gemeinsame
 * Partial _task_list_by_date.php mit linkTaskTitles=true; Titel verweisen
 * auf /admin/events/{id}, wo die volle Bearbeitungs-UI liegt.
 *
