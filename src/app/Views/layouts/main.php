...
$appVersion = $settings['app']['version'] ?? '1.4.7';
...
<head>
    ...
    <meta name="current-user-id" content="<?= (int) (isset($user) && $user !== null ? $user->getId() : 0) ?>">
...
<body data-unread-url="<?= ViewHelper::url('/api/unread-dialog-count') ?>"<?= $broadcastAttr ?>>
